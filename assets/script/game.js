cc.Class({
    ...
    //初始化物理引擎
    initPhysics() {
        cc.director.getCollisionManager().enabled = true;//开启碰撞功能
        // cc.director.getCollisionManager().enabledDebugDraw = true;//开启调试功能，碰撞体上面会有碰撞范围
    },
    ...
    destroyRandomBlock() {
        if (this.destroyTimes == -1) {
            ...
            this.destroyCountLabel.string = this.destroyTimes;
            if (this.destroyTimes == 0) {
                //禁用消除 按钮
    ...
    change() {
        if (this.changeTimes == -1) {
            ...
            this.changeCountLabel.string = this.changeTimes;
            if (this.changeTimes == 0) {
                //禁用消除 按钮
    ...
    reset() {
        if (this.resetTimes == -1) {
            ...
            this.resetCountLabel.string = this.resetTimes;
            if (this.resetTimes == 0) {
                //禁用消除 按钮
